...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('assets/dashboard/dist/img/ALTCLogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('assets/dashboard/dist/img/ALTCLogo.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
              ...
              @if (!$item['dropdownStatus'])
                    <li class="nav-item">
                      <a href="{{$item['route']}}" class="nav-link {{Route::is($item['active']) ?'active' : ''}}">
                          ...
                          <p>
                              {{$item['title'][Session::get('local',config('app.locale'))]}}
                              @if ($item['badge'])
                  ...
                  <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                      @foreach ($item['dropdown'] as  $dropdownItem)
                          <li class="nav-item">
                            <a href="{{$dropdownItem['route']}}" class="nav-link">
                              <i class="far fa-circle nav-icon"></i>
                              <p>{{$dropdownItem['title'][Session::get('local',config('app.locale'))]}}</p>
                            </a>
                          </li>
                        @endforeach
                      </ul>
